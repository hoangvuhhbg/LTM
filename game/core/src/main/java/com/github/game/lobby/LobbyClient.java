    ...
    public void start() {
        try (Scanner scanner = new Scanner(System.in)) {
            while (true) {
                ...
                while (!isConnect) {
                    System.out.print("\nAn (1) de Tao Phong, (2) de Vao Phong, (quit) de thoat: ");
                ...
                System.out.println("Go 'ready' de san sang/huy, 'start' de bat dau (neu la Host), 'quit' de thoat.");
                ...
                while (isInRoom) {
                    ...
                    if (input.equalsIgnoreCase("quit")) {
                        System.out.println("Dang roi khoi phong...");
                        try {
            ...
            while (true) {
                ...
                switch (packet.getType()) {
                    ...
                    case SERVER_UPDATE_LOBBY:
                        ...
                        System.out.println("-------------------------------------");
                        System.out.print("Lenh (ready/start/quit): ");
                        break;
                    ...
                    case SERVER_ERROR:
                        ...
                        if (packet.getData().toString().contains("Ten")) {
                            System.out.print("Vui long nhap ten khac: ");
                        }
                        break;
                    default:
                        break;
